...
CamMapPath = '../Result/2020-CVPR-SINet-New/';   % Put model results in this folder.
...
for d = 1:datasetNum
    ...
    for m = 1:modelNum
        ...
        camPath = [CamMapPath  dataset '/'];
        fprintf('camPath= %s\n',camPath);
        imgFiles = dir( 'E:\Î±×°ÎïÌå¼ì²â\SINet-master\Result\2020-CVPR-SINet-New\COD10K\*.png');
